            ...
            <div className="container-fluid w-100 bg-black" >
                <div className="row" >
                    ...
                    <div className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center">
                        ...
                        <p className="text-center  mt-5    " >Descubra os filmes que estão em alta e extraia informação deles. html 5, css 3, javascript, react, boostrap 5.  </p>
                    ...
                    <div className="  mt-5  col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p className=" text-center  mt-5  ">Uma loja virtual onde você pode encontrar roupas, jóias e informática. html 5, css 3, javascript, react, boostrap 5. </p>
                    ...
                    <div className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p className=" text-center mt-5  "> Descubra as condições climáticas de todas as regiões do mundo. html 5, css 3, javascript, react, boostrap 5. </p>
                    ...
                    <div className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p className=" text-center mt-5 ">Faça cálculos, resolva equações com essa arma poderosa científica. html 5, css 3, javascript. </p>

            ...
            <div style={{  backgroundColor: "#01011A"}} className="container-fluid w-100 "   >
                <div className="row" >
                    ...
                    <section className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center">
                        ...
                        <p  style={{color:"#6F848C"}} className="text-center  mt-5  fade   " >Descubra os filmes que estão em alta e extraia informação deles. html 5, css 3, javascript, react, boostrap 5.  </p>
                    ...
                    <section className="  mt-5  col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p  style={{color:"#6F848C"}} className=" text-center  mt-5  fade ">Uma loja virtual onde você pode encontrar roupas, jóias e informática. html 5, css 3, javascript, react, boostrap 5. </p>
                    ...
                    <section className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p  style={{color:"#6F848C"}} className=" text-center mt-5  fade"> Descubra as condições climáticas de todas as regiões do mundo. html 5, css 3, javascript, react, boostrap 5. </p>
                    ...
                    <section className="   mt-5 col-md-5 d-flex flex-column justify-content-around align-items-center ">
                        ...
                        <p  style={{color:"#6F848C"}} className=" text-center mt-5  fade ">Faça cálculos, resolva equações com essa arma poderosa científica. html 5, css 3, javascript. </p>

    ...
    <>
      ...
      <div className=" d-md-flex  desk ">
        ...
        <div style={{ height: "95vh", backgroundColor: "black" }} className=" col-md-7    ">
          ...
          <img style={{ height: "300px", left: "100px" }} src="./Captura de tela 2025-02-09 23023.png" className=" fadephoto  float-end position-relative"  />
        ...
        <div style={{ height: "95vh", backgroundImage: "url('src/Captura de tela 2025-02-10 194259.png')", backgroundSize: "cover" }} className=" col-md-5 "></div>
      ...
      <div className="  d-md-none mobile    ">
        ...
        <div style={{ height: "20vh", backgroundColor: "black" }} className=" d-flex justify-content-center align-items-end ">
          ...
          <img style={{ top: "100px", height: "200px" }} src="Captura de tela 2025-02-09 23023.png" className=" fadephotomobile position-relative d-flex justify-content-center align-items-end " />
        </div>


        <div style={{ backgroundImage: "url('Captura de tela 2025-02-10 201835.png')", backgroundSize: "cover", height: "50vh" }} className=" col-md-5 ">  <div style={{ top: "180px" }} className="d-flex position-relative  justify-content-center " >

  ...
  return (
    <>
      ...
      <div className=" d-md-flex desk flex-column  ">
        ...
        <main style={{ height: "95vh", backgroundColor: "#01011A", backgroundRepeat:"no-repeat", backgroundSize:"100vh", backgroundImage:"url('planet-earth-1457453_1280-Photoroom.jpg')", backgroundPositionY:"100%", backgroundPositionX:"50%" }} className=" d-flex flex-column text-center  col-md-12    ">
      
          <h1 style={{ color: "#6F848C", marginTop: "10vh" }} className="text-center fade "> Hello world !</h1>
